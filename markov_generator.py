...
class MarkovWordGenerator:
    ...
    def __init__(self, order=2, cutoff=0.1, verbose=False, words="en"):
        ...
        self.cache_file = self.cache_manager.get_cache_path(f"markov_chains_order{order}_{safe_words}")
    ...
    def _load_chains(self):
        ...
        if cache_data is None or cache_data.get('order') != self.order:
            self._vprint("Cache invalid or order mismatch, rebuilding...")
            self._load_and_build_chains()
            return
